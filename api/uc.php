...
//note include 通知方式
    ...
    require_once DISCUZ_ROOT.'./config.inc.php';
    require_once DISCUZ_ROOT.'./uc_client/include/db.class.php';
...
class uc_note {
    ...
    function synlogin($get, $post) {
        ...
        session_start();
        /*
        $_SESSION['tuan_site__id'] = $uid;
        $_SESSION['tuan_site__name'] = $username;
        */
        $_SESSION['aima_try_userid'] = $uid;
        $_SESSION['aima_try_username'] = $username;
        header('P3P: CP="CURa ADMa DEVa PSAo PSDo OUR BUS UNI PUR INT DEM STA PRE COM NAV OTC NOI DSP COR"');
        //_setcookie('aima_try_auth', _authcode($uid."\t".$username, 'ENCODE'));
        setcookie("aima_try_auth", _authcode($uid."\t".$username, 'ENCODE'), time()+86400, '/');
    }

    function synlogout($get, $post) {
        if(!API_SYNLOGOUT) {
            $_SESSION['aima_try_userid'] = "";
            $_SESSION['aima_try_username'] = "";
            return API_RETURN_FORBIDDEN;
        }
        $_SESSION['aima_try_userid'] = "";
        $_SESSION['aima_try_username'] = "";
